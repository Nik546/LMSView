...
<nav><ul>
    ...
    <li><a class="active" href="/getAllEmployee">Delete Employee</a></li>
...
<div class="container">
    ...
    <%--<form:form  class="container" style=" width: 100% ;length: 100%" action="/deleteNowEmp" modelAttribute="employee">--%>
        <h1 color='ff0000'>Welcome Admin</h1>
        <tr>
            <th> Employee</th>
        </tr>
        <c:forEach var="emp" items="${employees}">
            <form:form action="/deleteNowEmp" modelAttribute="employee">

                <td>

                <td> <form:input type="hidden" name="username" path="username" value="${emp.getUsername()}"/> ${emp.getUsername()}</td>
