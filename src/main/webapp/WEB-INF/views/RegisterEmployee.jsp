...
<nav><ul>
    ...
    <li><a class="active" href="/AddEmployee">Add Employee</a></li>
...
<div class="container">
    <div class="page-header" onclick="/RegistrateEmployee.jsp"> </div>
    <form:form  class="container" style=" width: 100% ;length: 100%" action="/register" method="post" modelAttribute="employee">
        ...
        <div class="form-group">
            <label for="company">Company:</label><br><form:input path="companyName" type="text" class="form-group" name="companyName" id="company" placeholder="Company name" />
        </div>
        <div class="form-group">
