        ...
        <div class="w3-col m7">
            ...
            <form action="/action_page.php" style="border:1px solid #ccc">
                <div class="container">
                    ...
                    <input type="text" placeholder="Enter Id" name="Employee Id" required>
                    <br>
                    <br>
                    <br>

                    <label for="id"><b>Leave Id</b></label>
                    <input type="text" placeholder="" name="Leave Id" required>
                    ...
                    <div class="clearfix">
                        <button type="button" class="cancelbtn">DELETE REQUEST</button>
                        <button type="submit" class="signupbtn">SUBMIT REQUEST</button>
                    </div>
                </div>
            </form>
