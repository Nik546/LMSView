...
<nav><ul>
    ...
    <li><a class="active" href="/addCompany1">Add Company</a></li>
...
<div class="container">
    ...
    <form:form  class="container" style=" width: 100% ;length: 100%" action="/addCompany" method="post" modelAttribute="company">
        <h1 color='ff0000'>Welcome Admin</h1>

        <div class="form-group">
            <label for="firstname"> Company Name:</label><br><form:input type="text" name="companyName" path="companyName" id="firstname" placeholder="Company name" />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="mailid">Type:</label> <br><form:input type="text" name="Type" path="Type" id="mailid" placeholder="Type of Holiday" />
        </div>

        <div class="form-group">
            <label for="mailid">Address:</label> <br><form:input type="text" name="Address" path="Address" id="mailid" placeholder="Address" />
        </div>

        <div class="form-group">
            <label for="uname1">State:</label> <br><form:input type="text" path="State" class="form-group" name="State" id="uname1" placeholder="State" />
        </div>
